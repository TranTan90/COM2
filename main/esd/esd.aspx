...
<td style="width:5% ; text-align:center ;  font-weight: bold;    float: right; margin-top: 15px;">
                            <a href="/COMS/Default.aspx"><img src="/COMS/images/logo22.png" border="0"></a></td>
                        </tr>
                        <tr><a href="/COMS/logout.aspx" class="btn_logout" onclick="goLogout();return false;">                            
                         <img src="/COMS/images/logout.gif" style=" width:50px;height:40px ; float: right; "border="0"alt="LogOut""/> </a>
                         <a href="/COMS/logout.aspx" style="float: right; ">Logout</a></tr>
</table>
    ...
    <table width="100%">
        <tr>
            <td style="text-align: center">
                <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound1" CssClass="table table-hover">
                    <Columns>
                        ...
                        <asp:BoundField DataField="RegDate" HeaderText="Tên(성명)" SortExpression="RegDate" HeaderStyle-Width="200px">
                            <HeaderStyle HorizontalAlign="Center" BackColor="#003399" ForeColor="White" />
                        </asp:BoundField>
                        <asp:BoundField DataField="VisitObjectContents" HeaderText="Ngày,tháng,năm sinh(생년월일)" SortExpression="VisitObjectContents" HeaderStyle-Width="100px" >
                            <HeaderStyle HorizontalAlign="Center" BackColor="#003399" ForeColor="White" />
                        </asp:BoundField>
                        <asp:BoundField DataField="OfficeContents" HeaderText="Tên công ty (회사명)" SortExpression="OfficeContents" HeaderStyle-Width="250px">
                            <HeaderStyle HorizontalAlign="Center" BackColor="#003399" ForeColor="White" />
                        </asp:BoundField>
                        ...
                        <asp:HyperLinkField HeaderText="Đào tạo an toàn (안전 교육이수)" HeaderStyle-Width="100px">
    ...
    <asp:Panel ID="pnNotice" runat="server" Height="50px" HorizontalAlign="Center" Width="100%">
        Hãy tìm kiếm bằng tên chính xác vì vấn đề rò rỉ thông tin cá nhân (개인정보 누출로 인한 문제로 정확한 이름으로 검색하셔야 합니다).</asp:Panel>
