<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view.aspx.cs" Inherits="main_esd_test" %>
    ...
    <div class="">
        ...
        <a href=""></a>
            ...
            <h3 style="margin-left: 250px">
                <span style="margin-left: 250px">내방객 기초 준수 사항 </span>
                <br />
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            Khi xảy ra tình huống khẩn cấp, cần xác định đường lánh nạn khẩn cấp và tập trung
                            tại điểm tập kết
                        </td>
                    </tr>
                </table>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <span style="color: Blue">사내에서 항시 방문증을 패용하여 주십시오.</span><br />
                                Luôn đeo thẻ khách trong công ty.
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <span style="color: Blue">저장 및 촬영매체는 반입이 금지되어 있습니다. 보안실에 보관하여 주시기 바랍니다.</span>
                                <br />
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <span style="color: Blue">사내 물품을 임의 반출할 수 없습니다. 사전에 반출신고를 진행해야 합니다.</span><br />
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <span style="color: Blue">작업 전에는 안전작업허가를 받아야 합니다.</span>
                                <br />
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <span style="color: Blue">차량 운행 속도는 20KM/H이하이며, 운전, 보행 중 휴대폰 사용을 금지합니다.</span>
                                <br />
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <span style="color: Blue">지정된 흡연구역 외에는 모든 구역이 금연구역 입니다.</span>
                                <br />
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <span style="color: Blue">운전 또는 작업 중에 음주를 금지합니다.</span>
                                <br />
                                Cấm uống rượu trong khi làm việc hoặc lái xe
                            </td>
                        </tr>
                    </table>
                </div>
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <span style="color: Blue">보수 작업 또는 건축 작업 등 작업 현장 내 출입시 안전 보호구를 반드시 착용해야 합니다.</span>
                                <br />
                                Trường hợp xây dựng hoặc sửa chữa, khi ra vào nơi làm việc phải mặc đồ bảo hộ an
                                toàn
                            </td>
                        </tr>
                    </table>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <span style="color: Blue">중장비가 작업하는 구역 아래는 이동을 금지합니다.</span>
                                <br />
        ...
        <div>
            <span style="color: Blue">위반 사항이 발견될 경우 업무 중이라도 강제 출문될 수 있습니다. </span>
            <br />
            Trường hợp phát hiện vi phạm, có thể bị cưỡng chế ra khỏi công ty dù đang làm việc.<br />
            ...
            yêu cầu của người phụ trách an toàn/bảo an.<br />
            </td> <span style="color: Blue">하나마이크론 비나는 내방객 여러분의 안전을 보장하고, 사내 정보 자산을 보호하기 위하여 많은
                노력을 하고 있습니다</span><br />
            Công ty TNHH Hana Micron vina đang nỗ lực hết mình để bảo đảm an toàn cho các vị
            khách đến thăm cũng như bảo vệ tài sản, thông tin nội bộ của công ty<br />
            <span style="color: Blue">내방객 여러분들은 아래의 사항을 준수해야 하며 문제 사항이 발견될 경우 사내 담당자에게 내용을 즉시 전달해야
                합니다</span><br />
     ...
     <input  type=button onclick= window.history.go(-1) value="Back  " style="float:right; margin-right:100px" class="btn btn-primary"/>
